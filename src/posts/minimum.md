...
The link list (not) shown above was generated by adding the following shortcode to the page:

<code>
&#123;% pageLinks 2 10 %&#125;
</code>

The two (2) tells the shortcut to generate an unordered list. The 10 tells the shortcut to not generate anything unless there are 10 or more links on the page.
